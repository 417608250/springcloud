...
/**
 * DES加密处理工具类.主要用来对拓尔思产品IDS传输数据进行DES加密/解密操作
 * <p>
 * 若其他地方用到DES加解密，经测试适用，也可使用。
 *
 * @author hzj
 * @version $Date: 2017年3月22日 $
 */
public class DesEncryptUtil {
     ...
     *            转换的名称，例如 DES/CBC/PKCS5Padding。有关标准转换名称的信息，请参见 Java
     ...
     *            密钥
     * @param cipherMode
     *            此 Cipher的操作模式（为以下之一：ENCRYPT_MODE、DECRYPT_MODE、WRAP_MODE 或
     *            UNWRAP_MODE）
     * @param transformation
     *            转换的名称，例如 DES/CBC/PKCS5Padding。有关标准转换名称的信息，请参见 Java
     *            Cryptography Architecture Reference Guide 的附录 A。
    ...
    public static String decrypt(String encryptedDataHex, String keyData)
        ...
        String decryptedHexStr = DesEncryptUtil.decryptToHex(
                toBytes(encryptedDataHex), keyData);
     ...
     * 
     * @param algorithm
     *            所请求的秘密密钥算法的标准名称, 如"DES"。有关标准算法名称的信息，请参阅 Java Cryptography
